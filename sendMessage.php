...
$host2 = 'sql.turbosms.ua';
$database2 = '';
$username2 = '';
$password2 = '';

$dbCon = new PDO('dblib:charset=UTF-8;host=' . $host1 . ';database=' . $database1, $username1, $password1);
$dbConSMS = new PDO('mysql:host=' . $host2 . ';dbname=' . $database2 . ';charset=UTF8', $username2, $password2);
